...
export function buildPortraitPrompt(character: Character, visualStyleBible: string): string {
  ...
  return [
    visualStyleBible,
    `Portrait of ${character.name}, age ${visualState.currentAge}: ${appearance.height}, ${appearance.build}. ${appearance.face}, ${appearance.hair} hair, ${appearance.eyes} eyes.`,
    ...
    visualState.currentCondition && visualState.currentCondition !== 'healthy'
      ? `Current condition: ${visualState.currentCondition}.`
      : '',
