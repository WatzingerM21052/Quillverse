...
## Still technically missing

Real-alpha cutouts for Anne, Grace, and Thomas are not present. Built-in image
generation again produced opaque RGB files with a painted transparency pattern.
Those attempts are preserved only under the matching
`pictures/Experimentelles/world-packs/bridgerton/final-family-2026-08-21/`
folder and must not be used as cutouts.
