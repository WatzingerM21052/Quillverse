# Gate-1 Generation Prompts

All assets use the built-in `image_gen` tool. Each prompt below is preserved
verbatim before generation. If a hard-constraint failure requires a targeted
...
## A-ICON-01 — App-icon concept board
...
## B-LOGO-01 — Celestial Archive mark
...
## B-BANNER-01 — Celestial Archive banner
...
## C-LOGO-01 — Storybook Crest mark
...
## C-BANNER-01 — Storybook Crest banner
